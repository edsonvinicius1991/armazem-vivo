  ...
  useEffect(() => {
    if (produto) {
      form.reset({
        ...
        peso_kg: produto.peso_unitario || undefined,
        altura_cm: produto.dimensoes?.altura || undefined,
        largura_cm: produto.dimensoes?.largura || undefined,
        profundidade_cm: produto.dimensoes?.profundidade || undefined,
        custo_unitario: produto.valor_unitario || undefined,
        preco_venda: produto.valor_unitario || undefined,
  ...
  const onSubmit = async (data: ProdutoFormData) => {
    try {
      ...
      const produtoData = {
        ...
        peso_unitario: data.peso_kg || null,
        dimensoes: (data.altura_cm || data.largura_cm || data.profundidade_cm) ? {
          altura: data.altura_cm || 0,
          largura: data.largura_cm || 0,
          profundidade: data.profundidade_cm || 0
        } : null,
        valor_unitario: data.custo_unitario || data.preco_venda || null,
